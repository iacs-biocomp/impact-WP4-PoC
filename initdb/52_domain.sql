INSERT INTO omop."domain" (domain_id,domain_name,domain_concept_id) VALUES
	 ...
	 ('Condition Status','OMOP Condition Status',32889),
	 ('Condition/Device','Condition/Device',235),
	 ('Condition/Drug','Condition/Drug',53),
	 ('Condition/Meas','Condition/Measurement',47),
	 ('Condition/Obs','Condition/Observation',48),
...
INSERT INTO omop."domain" (domain_id,domain_name,domain_concept_id) VALUES
	 ...
	 ('Meas Value Operator','Measurement Value Operator',23),
	 ('Meas/Procedure','Measurement/Procedure',43),
	 ('Measurement','Measurement',21),
	 ('Measurement/Obs','Measurement/Observation',44),
	 ('Metadata','Metadata',7),
	 ('Modifier','Modifier',12),
	 ('Note','Note',5085);
INSERT INTO omop."domain" (domain_id,domain_name,domain_concept_id) VALUES
	 ('Obs/Procedure','Observation/Procedure',42),
	 ('Observation','Observation',27),
	 ('Payer','Payer - institution administering healthcare transactions',32477),
	 ('Place of Service','Place of Service',32),
	 ('Plan','Health Plan - contract to administer healthcare transactions by the payer, facilitated by the sponsor',32475),
	 ('Plan Stop Reason','Plan Stop Reason - Reason for termination of the Health Plan',32478),
...
INSERT INTO omop."domain" (domain_id,domain_name,domain_concept_id) VALUES
	 ...
	 ('Route','Route Of Administration',15),
	 ('Spec Anatomic Site','Specimen Anatomic Site',38),
	 ('Spec Disease Status','Specimen Disease Status',39),
	 ('Specimen','Specimen',36),
	 ('Sponsor','Sponsor - institution or individual financing healthcare transactions',32476),
