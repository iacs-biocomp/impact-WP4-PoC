...
INSERT INTO relationship (relationship_id,relationship_name,is_hierarchical,defines_ancestry,reverse_relationship_id,relationship_concept_id) VALUES
	 ...
	 ('Is a','Is a','0','0','Subsumes',44818821),
...
INSERT INTO relationship (relationship_id,relationship_name,is_hierarchical,defines_ancestry,reverse_relationship_id,relationship_concept_id) VALUES
	 ...
	 ('Has Answer','Has Answer','0','0','Answer of',45754683),
...
INSERT INTO relationship (relationship_id,relationship_name,is_hierarchical,defines_ancestry,reverse_relationship_id,relationship_concept_id) VALUES
	 ('Drug class of drug','Drug class of drug (OMOP)','1','0','Drug has drug class',233),
	 ('Panel contains','Panel contains','1','1','Contained in panel',46233678),
	 ('Contained in panel','Contained in panel','1','0','Panel contains',46233679),
...
INSERT INTO relationship (relationship_id,relationship_name,is_hierarchical,defines_ancestry,reverse_relationship_id,relationship_concept_id) VALUES
	 ...
	 ('Rx support med of','RxNorm Supportive medication of (HemOnc)','0','0','Has support med Rx',32631),
...
INSERT INTO relationship (relationship_id,relationship_name,is_hierarchical,defines_ancestry,reverse_relationship_id,relationship_concept_id) VALUES
	 ...
	 ('RxNorm - ATC pr lat','RxNorm/Extension to ATC pr lateral (OMOP)','0','0','ATC - RxNorm pr lat',32796),
	 ('ATC - RxNorm sec lat','ATC to RxNorm/Extension secondary lateral (OMOP)','0','0','RxNorm - ATC sec lat',32797),
	 ('RxNorm - ATC sec lat','RxNorm/Extension to ATC secondary lateral (OMOP)','0','0','ATC - RxNorm sec lat',32798),
	 ('ATC - RxNorm pr up','ATC to RxNorm/Extension primary upwards (OMOP)','0','0','RxNorm - ATC pr up',32799),
	 ('RxNorm - ATC pr up','RxNorm/Extension to ATC primary upwards (OMOP)','0','0','ATC - RxNorm pr up',32800),
	 ('ATC - RxNorm sec up','ATC to RxNorm/Extension secondary upwards (OMOP)','0','0','RxNorm - ATC sec up',32801),
	 ('RxNorm - ATC sec up','RxNorm/Extension to ATC secondary upwards (OMOP)','0','0','ATC - RxNorm sec up',32802),
	 ('Has question source','Has question source','0','0','Question source of',32803),
	 ('Question source of','Question source of','0','0','Has question source',32804),
	 ('Has Value','Has Value','0','0','Value of',32972),
	 ('Value of','Value of','0','0','Has Value',32973),
	 ('Category in Chapter','Category in Chapter','0','0','Chapter has Category',32952),
	 ('Chapter has Category','Chapter has Category','0','0','Category in Chapter',32953),
	 ('Chapter to ICDO','Chapter to ICDO','0','0','ICDO to Chapter',32954),
	 ('ICDO to Chapter','ICDO to Chapter','0','0','Chapter to ICDO',32955),
	 ('Has precoord pair','Has precoordinated (Question-Answer/Variable-Value) pair','0','0','Precoord pair of',32970),
	 ('Precoord pair of','Precoordinated (Question-Answer/Variable-Value) pair of','0','0','Has precoord pair',32971),
	 ('Has Category','Has Category','0','0','Category of',32974),
	 ('Category of','Category of','1','1','Has Category',32975),
	 ('Has biosimilar','Has biosimilar','0','0','Biosimilar of',32977),
	 ('Biosimilar of','Biosimilar of','0','0','Has biosimilar',32978),
	 ('Relative to','Relative to (SNOMED)','0','0','Relative to of',32979),
	 ('Relative to of','Relative to of (SNOMED)','0','0','Relative to',32980),
	 ('Has count of act ing','Count of active ingredients (SNOMED)','0','0','Count of act ing in',32981);
INSERT INTO relationship (relationship_id,relationship_name,is_hierarchical,defines_ancestry,reverse_relationship_id,relationship_concept_id) VALUES
	 ('Count of act ing in','Is count of active ingredients in (SNOMED)','0','0','Has count of act ing',32982),
	 ('Has prod character','Has product characteristic (SNOMED)','0','0','Prod character of',32983),
	 ('Prod character of','Product characteristic of (SNOMED)','0','0','Has prod character',32984),
	 ('Has surface char','Has surface characteristic (SNOMED)','0','0','Surf character of',32985),
	 ('Surf character of','Surface characteristic of (SNOMED)','0','0','Has surface char',32986),
	 ('Has dev intend site','Has device intended site (SNOMED)','0','0','Dev intended site of',32987),
	 ('Dev intended site of','Device intended site of (SNOMED)','0','0','Has dev intend site',32988),
	 ('Has comp material','Has compositional material (SNOMED)','0','0','Comp material of',32989),
	 ('Comp material of','Compositional material of (SNOMED)','0','0','Has comp material',32990),
	 ('Has filling','Has filling (SNOMED)','0','0','Filling of',32991),
	 ('Filling of','Filling material of (SNOMED)','0','0','Has filling',32992),
	 ('Has variant','Reference to variant','0','0','Variant of',32997),
	 ('Variant of','Variant refer to concept','0','0','Has variant',32998),
	 ('Transcribes to','Genomic DNA transcribes to mRNA','1','1','Is transcribed from',32919),
	 ('Translates to','mRNA Translates to protein','1','1','Is translated from',32921),
	 ('Is transcribed from','mRNA is transcribed from genomic DNA','0','0','Transcribes to',32920),
	 ('Is translated from','Protein is translated from mRNA','0','0','Translates to',32922),
	 ('OncoTree to ICDO eq','OncoTree to ICDO equivalent','0','0','ICDO to OncoTree eq',33009),
	 ('ICDO to OncoTree eq','ICDO to OncoTree equivalent','0','0','OncoTree to ICDO eq',33010),
	 ('OncoTree to ICDO br','OncoTree to ICDO broader','0','0','ICDO br to OncoTree',33011),
	 ('ICDO br to OncoTree','ICDO broader to OncoTree','0','0','OncoTree to ICDO br',33012),
	 ('Has AB-drug cjgt','Has antibody-drug conjugate (HemOnc)','0','0','AB-drug cjgt of',33015),
	 ('AB-drug cjgt of','Antibody-drug conjugate of (HemOnc)','0','0','Has AB-drug cjgt',33016),
	 ('Has AB-drug cjgt Rx','Has antibody-drug conjugate - RxNorm (HemOnc)','0','0','Rx AB-drug cjgt of',33017),
	 ('Has FDA labeling','Has FDA labeling (HemOnc)','0','0','FDA labeling of',33019),
	 ('FDA labeling of','FDA labeling of (HemOnc)','0','0','Has FDA labeling',33020),
	 ('Has cytotoxic chemo','Has cytotoxic chemotherapy (HemOnc)','0','0','Cytotoxic chemo of',33021),
	 ('Cytotoxic chemo of','Cytotoxic chemotherapy of (HemOnc)','0','0','Has cytotoxic chemo',33022),
	 ('Has cytotox chemo Rx','Has cytotoxic chemotherapy - RxNorm (HemOnc)','0','0','Cytotox chemo RX of',33023),
	 ('Cytotox chemo RX of','Cytotoxic chemotherapy of - RxNorm (HemOnc)','0','0','Has cytotox chemo Rx',33024),
	 ('Has endocrine tx','Has endocrine therapy (HemOnc)','0','0','Endocrine tx of',33025),
	 ('Endocrine tx of','Endocrine therapy of (HemOnc)','0','0','Has endocrine tx',33026),
	 ('Has endocrine tx Rx','Has endocrine therapy - RxNorm (HemOnc)','0','0','Rx endocrine tx of',33027),
	 ('Has immunotherapy','Has immunotherapy (HemOnc)','0','0','Immunotherapy of',33029),
	 ('Immunotherapy of','Immunotherapy of (HemOnc)','0','0','Has immunotherapy',33030),
	 ('Has immunotherapy Rx','Has immunotherapy - RxNorm (HemOnc)','0','0','Rx immunotherapy of',33031),
	 ('Has pept-drug cjgt','Has peptide-drug conjugate (HemOnc)','0','0','Pept-drug cjgt of',33033),
	 ('Pept-drug cjgt of','Peptide-drug conjugate of (HemOnc)','0','0','Has pept-drug cjgt',33034),
	 ('Has pept-drg cjg Rx','Has peptide-drug conjugate - RxNorm (HemOnc)','0','0','Rx pept-drg cjg of',33035),
	 ('Has radioconjugate','Has radioconjugate (HemOnc)','0','0','Radioconjugate of',33037),
	 ('Radioconjugate of','Radioconjugate of (HemOnc)','0','0','Has radioconjugate',33038),
	 ('Has radiocjgt Rx','Has radioconjugate - RxNorm (HemOnc)','0','0','Rx radiocjgt of',33039),
	 ('Has radiotherapy','Has radiotherapy (HemOnc)','0','0','Radiotherapy of',33041),
	 ('Radiotherapy of','Radiotherapy of (HemOnc)','0','0','Has radiotherapy',33042),
	 ('Has radiotherapy Rx','Has radiotherapy - RxNorm (HemOnc)','0','0','Rx radiotherapy of',33043),
	 ('Has targeted therapy','Has targeted therapy (HemOnc)','0','0','Targeted therapy of',33045),
	 ('Targeted therapy of','Targeted therapy of (HemOnc)','0','0','Has targeted therapy',33046),
	 ('Has targeted tx Rx','Has targeted therapy - RxNorm (HemOnc)','0','0','Rx targeted tx of',33047),
	 ('Has support med Rx','Has supportive medication - RxNorm (HemOnc)','0','0','Rx support med of',32630),
	 ('Has coating material','Has coating material (SNOMED)','0','0','Coating material of',33052);
INSERT INTO relationship (relationship_id,relationship_name,is_hierarchical,defines_ancestry,reverse_relationship_id,relationship_concept_id) VALUES
	 ('Coating material of','Coating material of (SNOMED)','0','0','Has coating material',33053),
	 ('Has absorbability','Has absorbability (SNOMED)','0','0','Absorbability of',33054),
	 ('Absorbability of','Absorbability of (SNOMED)','0','0','Has absorbability',33055),
	 ('Process extends to','Process extends to (SNOMED)','0','0','Process extends from',33056),
	 ('Process extends from','Process extends from (SNOMED)','0','0','Process extends to',33057),
	 ('Has strength','Has ingredient qualitative strength (SNOMED)','0','0','Strength of',33058),
	 ('Rx AB-drug cjgt of','RxNorm antibody-drug conjugate of (HemOnc)','1','1','Has AB-drug cjgt Rx',33018),
	 ('Rx endocrine tx of','RxNorm endocrine therapy of (HemOnc)','1','1','Has endocrine tx Rx',33028),
	 ('Rx immunotherapy of','RxNorm immunotherapy of (HemOnc)','1','1','Has immunotherapy Rx',33032),
	 ('Rx pept-drg cjg of','RxNorm peptide-drug conjugate of (HemOnc)','1','1','Has pept-drg cjg Rx',33036),
	 ('Rx radiocjgt of','RxNorm radioconjugate of (HemOnc)','1','1','Has radiocjgt Rx',33040),
	 ('Rx radiotherapy of','RxNorm radiotherapy of (HemOnc)','1','1','Has radiotherapy Rx',33044),
	 ('Rx targeted tx of','RxNorm targeted therapy of (HemOnc)','1','1','Has targeted tx Rx',33048),
	 ('Strength of','Ingredient qualitative strength of (SNOMED)','0','0','Has strength',33059),
	 ('Has surface texture','Has surface texture (SNOMED)','0','0','Surface texture of',33060),
	 ('Surface texture of','Surface texture of (SNOMED)','0','0','Has surface texture',33061),
	 ('Is sterile','Is sterile (SNOMED)','0','0','Is sterile of',33062),
	 ('Is sterile of','Is sterile of (SNOMED)','0','0','Is sterile',33063),
	 ('Has targ population','Has target population (SNOMED)','0','0','Targ population of',33064),
	 ('Targ population of','Target population of (SNOMED)','0','0','Has targ population',33065),
	 ('Has status','Has status','0','0','Status of',33066),
	 ('Status of','Status of','0','0','Has status',33067);
