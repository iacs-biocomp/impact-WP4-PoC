...
ALTER TABLE omop.PERSON ADD CONSTRAINT fpk_PERSON_race_concept_id FOREIGN KEY (race_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);
...
ALTER TABLE omop.PERSON ADD CONSTRAINT fpk_PERSON_location_id FOREIGN KEY (location_id) REFERENCES omop.LOCATION (LOCATION_ID);
...
ALTER TABLE omop.PERSON ADD CONSTRAINT fpk_PERSON_care_site_id FOREIGN KEY (care_site_id) REFERENCES omop.CARE_SITE (CARE_SITE_ID);
...
ALTER TABLE omop.PERSON ADD CONSTRAINT fpk_PERSON_race_source_concept_id FOREIGN KEY (race_source_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);
...
ALTER TABLE omop.OBSERVATION_PERIOD ADD CONSTRAINT fpk_OBSERVATION_PERIOD_person_id FOREIGN KEY (person_id) REFERENCES omop.PERSON (PERSON_ID);
...
ALTER TABLE omop.VISIT_OCCURRENCE ADD CONSTRAINT fpk_VISIT_OCCURRENCE_person_id FOREIGN KEY (person_id) REFERENCES omop.PERSON (PERSON_ID);
...
ALTER TABLE omop.VISIT_OCCURRENCE ADD CONSTRAINT fpk_VISIT_OCCURRENCE_visit_type_concept_id FOREIGN KEY (visit_type_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);
...
ALTER TABLE omop.VISIT_OCCURRENCE ADD CONSTRAINT fpk_VISIT_OCCURRENCE_care_site_id FOREIGN KEY (care_site_id) REFERENCES omop.CARE_SITE (CARE_SITE_ID);
...
ALTER TABLE omop.VISIT_OCCURRENCE ADD CONSTRAINT fpk_VISIT_OCCURRENCE_admitting_source_concept_id FOREIGN KEY (admitting_source_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);

ALTER TABLE omop.VISIT_OCCURRENCE ADD CONSTRAINT fpk_VISIT_OCCURRENCE_discharge_to_concept_id FOREIGN KEY (discharge_to_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);

ALTER TABLE omop.VISIT_OCCURRENCE ADD CONSTRAINT fpk_VISIT_OCCURRENCE_preceding_visit_occurrence_id FOREIGN KEY (preceding_visit_occurrence_id) REFERENCES omop.VISIT_OCCURRENCE (VISIT_OCCURRENCE_ID);
...
ALTER TABLE omop.VISIT_DETAIL ADD CONSTRAINT fpk_VISIT_DETAIL_admitting_source_concept_id FOREIGN KEY (admitting_source_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);

ALTER TABLE omop.VISIT_DETAIL ADD CONSTRAINT fpk_VISIT_DETAIL_discharge_to_concept_id FOREIGN KEY (discharge_to_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);
...
ALTER TABLE omop.VISIT_DETAIL ADD CONSTRAINT fpk_VISIT_DETAIL_visit_detail_parent_id FOREIGN KEY (visit_detail_parent_id) REFERENCES omop.VISIT_DETAIL (VISIT_DETAIL_ID);
...
ALTER TABLE omop.CONDITION_OCCURRENCE ADD CONSTRAINT fpk_CONDITION_OCCURRENCE_person_id FOREIGN KEY (person_id) REFERENCES omop.PERSON (PERSON_ID);
...
ALTER TABLE omop.CONDITION_OCCURRENCE ADD CONSTRAINT fpk_CONDITION_OCCURRENCE_condition_type_concept_id FOREIGN KEY (condition_type_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);
...
ALTER TABLE omop.CONDITION_OCCURRENCE ADD CONSTRAINT fpk_CONDITION_OCCURRENCE_provider_id FOREIGN KEY (provider_id) REFERENCES omop.PROVIDER (PROVIDER_ID);
...
ALTER TABLE omop.CONDITION_OCCURRENCE ADD CONSTRAINT fpk_CONDITION_OCCURRENCE_visit_detail_id FOREIGN KEY (visit_detail_id) REFERENCES omop.VISIT_DETAIL (VISIT_DETAIL_ID);
...
ALTER TABLE omop.DRUG_EXPOSURE ADD CONSTRAINT fpk_DRUG_EXPOSURE_person_id FOREIGN KEY (person_id) REFERENCES omop.PERSON (PERSON_ID);
...
ALTER TABLE omop.DRUG_EXPOSURE ADD CONSTRAINT fpk_DRUG_EXPOSURE_drug_type_concept_id FOREIGN KEY (drug_type_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);
...
ALTER TABLE omop.DRUG_EXPOSURE ADD CONSTRAINT fpk_DRUG_EXPOSURE_provider_id FOREIGN KEY (provider_id) REFERENCES omop.PROVIDER (PROVIDER_ID);
...
ALTER TABLE omop.DRUG_EXPOSURE ADD CONSTRAINT fpk_DRUG_EXPOSURE_visit_detail_id FOREIGN KEY (visit_detail_id) REFERENCES omop.VISIT_DETAIL (VISIT_DETAIL_ID);
...
ALTER TABLE omop.PROCEDURE_OCCURRENCE ADD CONSTRAINT fpk_PROCEDURE_OCCURRENCE_person_id FOREIGN KEY (person_id) REFERENCES omop.PERSON (PERSON_ID);
...
ALTER TABLE omop.PROCEDURE_OCCURRENCE ADD CONSTRAINT fpk_PROCEDURE_OCCURRENCE_procedure_type_concept_id FOREIGN KEY (procedure_type_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);
...
ALTER TABLE omop.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_measurement_concept_id FOREIGN KEY (measurement_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);
...
ALTER TABLE omop.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_operator_concept_id FOREIGN KEY (operator_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);
...
ALTER TABLE omop.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_unit_concept_id FOREIGN KEY (unit_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);
...
ALTER TABLE omop.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_visit_occurrence_id FOREIGN KEY (visit_occurrence_id) REFERENCES omop.VISIT_OCCURRENCE (VISIT_OCCURRENCE_ID);
...
ALTER TABLE omop.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_measurement_source_concept_id FOREIGN KEY (measurement_source_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);
...
ALTER TABLE omop.OBSERVATION ADD CONSTRAINT fpk_OBSERVATION_observation_concept_id FOREIGN KEY (observation_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);
...
ALTER TABLE omop.OBSERVATION ADD CONSTRAINT fpk_OBSERVATION_value_as_concept_id FOREIGN KEY (value_as_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);
...
ALTER TABLE omop.OBSERVATION ADD CONSTRAINT fpk_OBSERVATION_unit_concept_id FOREIGN KEY (unit_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);
...
ALTER TABLE omop.OBSERVATION ADD CONSTRAINT fpk_OBSERVATION_visit_occurrence_id FOREIGN KEY (visit_occurrence_id) REFERENCES omop.VISIT_OCCURRENCE (VISIT_OCCURRENCE_ID);
...
ALTER TABLE omop.OBSERVATION ADD CONSTRAINT fpk_OBSERVATION_observation_source_concept_id FOREIGN KEY (observation_source_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);

ALTER TABLE omop.DEATH ADD CONSTRAINT fpk_DEATH_person_id FOREIGN KEY (person_id) REFERENCES omop.PERSON (PERSON_ID);
...
ALTER TABLE omop.ATTRIBUTE_DEFINITION ADD CONSTRAINT fpk_ATTRIBUTE_DEFINITION_attribute_type_concept_id FOREIGN KEY (attribute_type_concept_id) REFERENCES omop.CONCEPT (CONCEPT_ID);
